...
public class JitsiMeetPlugin() : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    companion object {
        ...
        const val PLUGIN_TAG = "MEET_PLUGIN"
        const val METHOD_CHANNEL = "meet"
        const val EVENT_CHANNEL = "meet_events"
    ...
    override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
        Log.d(PLUGIN_TAG, "method: ${call.method}")
        Log.d(PLUGIN_TAG, "arguments: ${call.arguments}")
    ...
    private fun joinMeeting(call: MethodCall, result: Result) {
        ...
        Log.d(PLUGIN_TAG, "Joining Room: $room")
        ...
        Log.d(PLUGIN_TAG, "Server URL: $serverURL, $serverURLString")
    ...
    private fun closeMeeting(call: MethodCall, result: Result) {
        val intent = Intent(MEETING_CLOSE)
