...
import 'package:room/meeting.dart';
import 'package:room/services/dynamic_link_service.dart';
import 'package:room/services/route_generator.dart';
import 'package:room/widgets/awesome_buttons.dart';
import 'package:room/widgets/awesome_containers.dart';
import 'package:room/widgets/awesome_textfield.dart';
...
class _MeetingBoxState extends State<MeetingBox> {
  ...
  Future<Uri> createDynamicLink(roomId) async {
    final ShortDynamicLink shortenedLink =
      ...
      Uri.parse(
          'https://adherer.page.link/?link=https://adherer-io.web.app/%23/room?roomId=$roomId&apn=yt.smazer.gabble.room'),
